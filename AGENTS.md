...
committed here so it loads every session (Codex and Cowork) without a plugin install. Reinforces
...
Commits: no Codex session links, no "Generated by Codex", no co-author trailers.
