...
- ✅ **G3 stress — PASS** (on the F1 code, 2026-06-19): `test_betadelta_hybr_stress` 2/2 (incl. `test_hybr_implicit_converges_and_matches_golden` — F1 reproduces the golden under stress) + `test_bubble_solver_stress` 1/1 (15 smoke runs, **0 nondeterministic LSODA crashes**). F1 doesn't reintroduce the integrator-robustness bug.
