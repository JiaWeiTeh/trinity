...
├── switchon-successor/    can dt_switchon's fixed 1e-3 Myr clock be made physical? (🔵 batches 1-3 done — PLAN.md)
...
- **`switchon-successor/`** — [`PLAN.md`](switchon-successor/PLAN.md): given that the ramp cannot
  ...
  500-87,000× shorter). 🔵 **Batches 1-3 done, nothing implemented.** Bar N3 forbids swapping in
  ...
  constant). What remains is **S4**, fixing the inconsistent seed that made the ramp necessary.
