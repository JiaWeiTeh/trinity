...
(harness `docs/dev/scratch/betadelta-velstruct/hunt.py`, which wraps `solve_betadelta_pure` and dumps
...
`docs/dev/scratch/betadelta-velstruct/compare_hold.py`): for the four configs with real inflow, every
...
OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 \
    python docs/dev/scratch/betadelta-velstruct/hunt.py docs/dev/scratch/betadelta-velstruct/h1_steep_base.param \
    --out docs/dev/data/hunt_h1_steep_base.csv
python docs/dev/scratch/betadelta-velstruct/analyze_hunt.py docs/dev/data/hunt_h*.csv   # G6 verdict
```
...
+ configs live in `docs/dev/scratch/betadelta-velstruct/` (gitignored scratch — present locally).
