# docs/dev/scratch/betadelta-velstruct — velocity-structure ("Problem 2") hunt & treatment tooling
...
Plots from these CSVs: `docs/dev/scratch/betadelta-diagnostics/plot_hunt.py` (`hunt_trigger/massdep/dmdt_leads`).
See `docs/dev/scratch/betadelta-diagnostics/README.md` for the full run-name glossary and the other phases.
