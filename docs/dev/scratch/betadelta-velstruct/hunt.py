...
bubble thickness. Touches no production code.
    ...
    python docs/dev/scratch/betadelta-velstruct/hunt.py <param> --out docs/dev/data/hunt_<name>.csv
    python docs/dev/scratch/betadelta-velstruct/hunt.py <param> --validate-only
"""
import argparse
import csv
import dataclasses
