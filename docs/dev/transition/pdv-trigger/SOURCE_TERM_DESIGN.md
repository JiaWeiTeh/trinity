...
NEXT OPEN ITEM: **Phase 6 ruling IN PROGRESS (`FA_STATE_COUPLED.md §3`): f_mix RETAINED as fallback [RULED 2026-07-22], staged retirement gated on the state-coupled f_A; scalar-f_A-diagnostic + successor-greenlight pending an explicit nod.** Two review agents audited this plan on 2026-07-06 (config-coverage audit;
