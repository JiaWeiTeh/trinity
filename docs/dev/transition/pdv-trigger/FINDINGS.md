...
## 8. [data] The 819-run sweep landed — de-conflation verdict + the θ₁-collapse law (2026-07-01, pt3)
...
`data/fkappa_auto_verify.csv` (REPRODUCE #20). Caveats: calibration is densPL α=0, nISM 0.1,
