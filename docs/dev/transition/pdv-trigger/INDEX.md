...
| `FA_IMPLEMENTATION_SPEC.md` | 07-06 | E8 | executor-grade L1/L2 spec: edit sites, registry wiring, gate ladder + pass bars, theta5s matrix + registered predictions (p_source≈3.3; dMdt vs El-Badry Eq 47), traps, decision tree — **start here to implement f_A** | **live** |
