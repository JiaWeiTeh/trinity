...
| the physical in-ODE successor (f_A source term) | offline screen RUN 2026-07-06 (dial + El-Badry dMdt sign + stability); next = stiff fixtures screen (L1) then gated param + theta5-protocol matrix (L2) | 🟢 L0 done, L1–L2 open | `SOURCE_TERM_DESIGN.md`, FINDINGS §15 |
