...
on run; they match: dense-flat F0=F1=Eb-peak@0.197, steep blowout@2.728, retained
0.29/0.35). LaTeX-free: the script sets `text.usetex=False` (the repo
`paper/_lib/trinity.mplstyle` forces usetex, which has no TeX in this container).
