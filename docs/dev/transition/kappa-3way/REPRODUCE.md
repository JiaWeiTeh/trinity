...
**Status (2026-08-08):** ✅ all rows runnable — the 294 arms ran, reduced and landed; row 10's
`make_bench7_analysis.py` is written and is the three-way deliverable. Row 11 is the f_area Phase A0
