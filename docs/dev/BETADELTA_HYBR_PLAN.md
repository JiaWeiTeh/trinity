...
`python docs/dev/scratch/betadelta-diagnostics/analyze_arms.py`. **Re-verify these numbers against the
harness `docs/dev/scratch/betadelta-diagnostics/arms.py` and the jsonl before acting — this section
...
Ran six instrumented hybr configs (harness `docs/dev/scratch/betadelta-velstruct/hunt.py`, classifier
`docs/dev/scratch/betadelta-velstruct/analyze_hunt.py`) probing deeper/longer β+δ surges — stronger SN
...
`docs/dev/scratch/betadelta-velstruct/hunt.py --hold-inflow`, diff `docs/dev/scratch/betadelta-velstruct/compare_hold.py`):
