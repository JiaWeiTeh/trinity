...
``docs/dev/betadelta/PHASE2_ARMS.md`` (section "Phase 3 — self-consistent
...
Usage: python docs/dev/betadelta/diagnostics/analyze_phase3.py
"""
...
# --- transcribed from docs/dev/betadelta/PHASE2_ARMS.md (Phase 3 section) ---
