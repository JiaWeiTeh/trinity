...
| `rosette-cf/` | 🟡 RUNNING — 72-run Cf scan executing in-container (workers=3, heartbeat armed); deliverable = gzipped raw dicts committed under `data/` | `README.md` | 2026-07-13 |
