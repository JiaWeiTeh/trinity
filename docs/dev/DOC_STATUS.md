...
- **`dt_switchon`'s form (not its existence)** → `switchon-successor/PLAN.md` (🔵 Batches 1-3 done,
  **Batch 4 (S4, the consistent seed) pending**): can the fixed 1e-3 Myr clock become a scale-free
