...
- **`dt_switchon`'s form (not its existence)** → `switchon-successor/PLAN.md` (🔵 Batches 1-4 done,
  **Batch 5, the S0 write-up, is all that remains**): can the fixed 1e-3 Myr clock become a scale-free
