...
| `weak-winds/` | 🔵 ACTIONABLE — `FB_thermCoeffWind` sensitivity study (runnable bracket of "switch winds off"); harness + 10 tests green, smoke pair run, 15-run sweep designed **not run** | `PLAN.md` | 2026-08-08 |
