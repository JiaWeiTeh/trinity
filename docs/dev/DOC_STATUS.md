...
| `phase1a-init/` | 🔵 ACTIONABLE — M43-scale early-phase artifact diagnosed (segment-1 momentum injection, `vd=-1e8` + fixed 30-yr segment); log-spaced-segment fix proposed, not implemented | `FINDINGS.md` | 2026-08-04 |
