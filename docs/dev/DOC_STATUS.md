...
| `transition/kappa-3way/` | 🔵 ACTIVE — the three-way f_κ/f_A/f_mix band-entry calibration, measured fresh (cutoff 2026-07-29); **294/294 arms ran 2026-07-30 and the table is measured**; the f_area successor's offline screen ran 2026-08-03 and failed gate GA0, so bench8 was never submitted. **2026-08-08:** the `main` merge triggered the new CODE BASELINE clause — Θ₀ re-baseline came back 5 PASS / 1 FAIL (bench1 −1.3%, a window-length effect) — and **all three f_area options are now exhausted**, Option 3 screened out via Lancaster Eq 10 (0/3), whose inverted form predicts Θ inside the L21b band at TRINITY's own Ṙ_b/V_w | `report.html` | 2026-08-08 |
