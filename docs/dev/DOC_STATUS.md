...
| `weak-winds/` | 🔵 ACTIONABLE — `FB_thermCoeffWind` sensitivity study (runnable bracket of "switch winds off"); harness + 10 tests green, batch 0 H0 gate PASSES exactly (0.000e+00), smoke pair shows a fate flip at c=0.1; batches 1–5 designed + gated **not run** | `RUNBOOK.md` | 2026-08-08 |
