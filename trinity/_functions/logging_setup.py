...
def get_module_logger(name: str) -> logging.Logger:
    ...
    >>> from trinity._functions.logging_setup import get_module_logger
...
def set_log_level(level: Union[str, int], logger_name: Optional[str] = None):
    ...
    >>> set_log_level('WARNING', 'trinity.phase1_energy.run_energy_phase')
    """
...
def setup_logging_from_params(params):
    ...
    --------
    In main.py:
    >>> from trinity._functions.logging_setup import setup_logging_from_params
    >>>
    >>> def start_expansion(params):
...
if __name__ == "__main__":
    ...
    Run this file directly to see logging examples:
        python trinity/_functions/logging_setup.py
    """
    ...
    logger_main = logging.getLogger('trinity.main')
    logger_phase1 = logging.getLogger('trinity.phase1_energy.run_energy_phase')
    logger_cooling = logging.getLogger('trinity.cooling.net_coolingcurve')
    logger_sps = logging.getLogger('trinity.sps.update_feedback')
