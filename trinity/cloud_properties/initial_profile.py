...
This is the inverse of ``trinity/phase0_init/get_InitCloudProp.py``: instead
...
# ``trinity/_input/read_param.py`` and ``trinity/_output/cloudy/run_loader.py``.
...
def build_initial_cloud_profile(
    *,
    ...
    from trinity.phase0_init.get_InitCloudProp import (
