...
from trinity.bubble_structure.bubble_luminosity import (
...
# residual noise floor measured in the Phase-2.1 transect probe (docs/dev/scratch/betadelta-diagnostics),
