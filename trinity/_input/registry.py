...
SPECS: tuple[ParamSpec, ...] = (
    ...
    ParamSpec(name='v_neg_frac_thick', default=np.nan, info='Fraction of bubble thickness with inward (v<0) flow -- WARPFIELD "Problem 2" diagnostic (transient interior inflow during a feedback re-pressurisation). Grid-independent; diagnostic only, NOT used in any physics (v is absent from the cooling integrals). See docs/dev/betadelta/stalling-energy-phase.md.', category='runtime_bubble', unit='dimensionless'),
