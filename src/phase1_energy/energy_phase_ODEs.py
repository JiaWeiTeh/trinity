...
def get_ODE_Edot(y, t, params):
    ...
    ----------
    y contains:
        - r (R2), outer bubble radius [pc].
        - v (v2), outer bubble velocity [au]
    ...
    #         print('in try else')
    #         nR2 = bubble_n_arr[1] #takes the first element because the radius array is inversed.
    #         print('nR2', nR2)
