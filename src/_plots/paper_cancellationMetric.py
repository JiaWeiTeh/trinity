...
def plot_from_path(data_input: str, output_dir: str = None):
    ...
    plot_single(
        ...
        file_prefix="paper_cancellationMetric",
        figsize=(8, 5),
        legend_loc="upper right",
        title_fn=lambda p: f"Force Cancellation: {p.parent.name}",
        ylabel=r"Cancellation metric $\mathcal{C}$",
    )
